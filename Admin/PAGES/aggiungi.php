...
if($t){
    if(isset($_POST["nome"]) && isset($_POST["descrizione"]) && isset($_POST["costo"]))
    {
        ...
        $sql = "INSERT INTO Alimenti (Nome, Ingredienti, Costo, Usata) VALUES ('$nome', '$descrizione', '$costo', '$attiva')";
        $ID="";
